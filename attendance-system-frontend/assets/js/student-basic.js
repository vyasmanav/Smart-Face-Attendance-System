                      ...
                      <div class="col-lg-2">
                          <div class="logo-area">
                              <div class="symbol">                               
                                   ...
                                   <h5 class="fullname">${localStorage.getItem("fullname")}</h5>
                                   <!-- 462 -->
                              </div>
                          </div>
                      </div>
                      <div class="col-lg-9">
                          <nav id="mobile-menu">
                              <ul class="main-menu">
                                  ...
                                  <li class="has-submenu"><a href="#">Manage Biometric</a>
                                      <ul class="submenu">
                                          <li><a href="student-bio-reg.html">Register Face</a></li>
                                          <li><a href="student-bio-change.html">Change Face</a></li>
                                      </ul>
                                  </li>
                                  <li><a href="student-query.html">Query</a></li>
