            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <div class="logo-area">
                            <div class="symbol">
                                <a href="college-admin-home.html">
                                    <img src="assets/images/newlogo.jpg" alt="logo">
                                </a>
                                <h5 class="fullname">Prof. ${localStorage.getItem("fullname")}
                                </h5>
                                <!-- 462 -->
                            </div>
                        </div>
                    ...
                    <div class="col-lg-9">
                        <nav id="mobile-menu">
                            <ul class="main-menu">
                                <li><a href="college-admin-student-page.html">Manage Students</a></li>
                                <li><a href="college-admin-timetable-page.html">Manage Timetable</a></li>
                                <li><a href="college-admin-attendance.html">Class Footage</a></li>
                                <li class="menu-btn"><a href="college-admin-about.html">About Us</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
